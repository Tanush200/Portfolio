...
const Skills = () => {
  return (
    <div className="bg-gradient-to-b from-[#100f1e] to-[#34306d] py-24">
      <div className="text-white max-w-[1200px] mx-auto px-6 text-center">
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-[##70badf] to-[#70badf] rounded-full mx-auto mb-12"></div>

        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 cursor-pointer">
          {skillIcons.map((skill, index) => (
            <div
              key={index}
              className="flex flex-col justify-center items-center bg-white/10 p-6 rounded-xl hover:scale-105 hover:shadow-[0_0_15px_#70badf] transition-all duration-300 ease-in-out"
            >
